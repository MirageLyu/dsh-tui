 ...
 * @module @miragelyu/dsh-tui/chat/helpers
 */
...
/**
 * Fold the latest activity timestamp from one session log: the last event's
 * time, or `undefined` for an empty log. A cheap alternative to scanning
 * storage artifacts when the live log is in hand.
 * @param events - session events in log order.
 * @returns the last event's epoch milliseconds, or `undefined` when empty.
 */
