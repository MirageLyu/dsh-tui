...
This document is the detailed behavioral contract of the terminal UI: composition rows, the interaction surface, configuration, color, model experience, and known limitations. The repository front door — installation, quick start, keybindings, and feature overview — is [README.md](../README.md); the service contracts and Cordis API are on [docs/terminal-ui.md](terminal-ui.md).
